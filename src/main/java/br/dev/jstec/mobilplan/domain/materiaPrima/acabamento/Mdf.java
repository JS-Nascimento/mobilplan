...
import static br.dev.jstec.mobilplan.domain.materiaprima.TipoPrecificacao.M2;
import static br.dev.jstec.mobilplan.domain.materiaprima.Unidade.METRO_QUADRADO;
import static br.dev.jstec.mobilplan.domain.materiaprima.acabamento.CalculaPorLado.valueOf;
...
public class Mdf implements Acabamento {
    ...
    public static Mdf of(String descricao,
        ...
        return new Mdf(descricao, cor, valueOf(calculaPorLado),
    ...
    public static Mdf with(Long id,
        ...
        return new Mdf(id, descricao, cor, valueOf(calculaPorLado),
