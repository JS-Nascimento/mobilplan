...
import static br.dev.jstec.efurniture.infrastructure.exceptions.ErroTecnico.ERRO_INFORMACAO_INCONSISTENTE;
...
import br.dev.jstec.efurniture.infrastructure.exceptions.RequestException;
...
public class MarceneiroController {
    ...
    ResponseEntity<MarceneiroDto> alteraMarceneiro(@PathVariable String id,
        ...
        if (!id.equals(dto.id())) {
            ...
            throw new RequestException(BAD_REQUEST, ERRO_INFORMACAO_INCONSISTENTE.getMsg(),
