...
import static br.dev.jstec.mobilplan.application.domain.valueobject.EnderecoFixture.build;
import static br.dev.jstec.mobilplan.application.domain.valueobject.TelefoneFixture.buildCelularOuWhatsapp;
