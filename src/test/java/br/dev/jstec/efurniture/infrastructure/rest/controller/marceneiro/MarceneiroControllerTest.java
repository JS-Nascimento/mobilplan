...
import static br.dev.jstec.efurniture.application.usecases.marceneiro.AlterarMarceneiroUseCaseFixture.buildInputComUpdateMarceneiroDto;
import static br.dev.jstec.efurniture.application.usecases.marceneiro.AlterarSituacaoUseCaseFixture.buildOutput;
import static br.dev.jstec.efurniture.application.usecases.marceneiro.BuscarMarceneiroPorIdUseCaseFixture.buildOutput;
import static br.dev.jstec.efurniture.application.usecases.marceneiro.CriarMarceneiroUseCaseFixture.buildCriarMarceneiroUseCaseInputComNewMarceneiro;
import static br.dev.jstec.efurniture.application.util.JsonHelper.toJson;
...
import static br.dev.jstec.efurniture.infrastructure.rest.dto.marceneiro.MarceneiroDtoFixture.buildComTodosMarceneiroOutput;
import static br.dev.jstec.efurniture.infrastructure.rest.dto.marceneiro.NewMarceneiroDtoFixture.buildComParametros;
...
import br.dev.jstec.efurniture.application.usecases.marceneiro.AlterarMarceneiroUseCaseFixture;
...
import br.dev.jstec.efurniture.application.usecases.marceneiro.BuscarMarceneiroPorDocumentoUseCaseFixture;
import br.dev.jstec.efurniture.application.usecases.marceneiro.BuscarMarceneiroPorEmailUseCase;
import br.dev.jstec.efurniture.application.usecases.marceneiro.BuscarMarceneiroPorEmailUseCaseFixture;
...
import br.dev.jstec.efurniture.application.usecases.marceneiro.BuscarTodosMarceneirosUseCaseFixture;
...
import br.dev.jstec.efurniture.infrastructure.exceptions.CustomExceptionHandler;
import br.dev.jstec.efurniture.infrastructure.rest.dto.marceneiro.MarceneiroDtoFixture;
import br.dev.jstec.efurniture.infrastructure.rest.dto.marceneiro.ResponseMarceneiroDto;
import br.dev.jstec.efurniture.infrastructure.rest.dto.marceneiro.UpdateMarceneiroDtoFixture;
