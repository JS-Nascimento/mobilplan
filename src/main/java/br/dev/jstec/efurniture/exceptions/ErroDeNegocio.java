...
public enum ErroDeNegocio {
    ...
    ERRO_TIPO_CLIENTE_INVALIDO("EFURNITURE-003", "O Tipo Pessoa e Documento Fiscal são obrigatórios."),
    ERRO_CPF_INVALIDO("EFURNITURE-004", "O Cpf: {0} é inválido."),
    ERRO_CNPJ_INVALIDO("EFURNITURE-005", "O Cnpj: {0} é inválido."),
    ERRO_ENTIDADE_EXISTENTE("EFURNITURE-006", "Já existe um registro para {0} com os dados informados."),
